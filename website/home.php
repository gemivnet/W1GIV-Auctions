...
<div class="content-wrapper">
	<div class="container">
		...
		<section class="content-header">
			...
			<h1>
				Home<small>Manage Auctions, Payment, and Organization</small>
			</h1>

			<ol class="breadcrumb">
				<li class="active"><a href="/home.php"><i class="fa fa-dashboard"></i>
						Home</a></li>
			</ol>
			...
			<div class="box box-default">
				<div class="box-header with-border">
					...
					<div class="pull-right box-tools">
						<a href="/createType.php"
							class="btn btn-primary btn-normal pull-right">Create Auction</a>
					</div>
				...
				<div class="box-body">
					...
					<div class="box-body table-responsive no-padding">
						<table class="table table-hover">
							...
							<?php
							// Display auctions from this organization with details of each auction
